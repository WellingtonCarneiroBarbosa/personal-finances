...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list workspaces']);
        ...
        Permission::create(['name' => 'list workspaceusers']);
        Permission::create(['name' => 'view workspaceusers']);
        Permission::create(['name' => 'create workspaceusers']);
        Permission::create(['name' => 'update workspaceusers']);
        Permission::create(['name' => 'delete workspaceusers']);
